    ...
    <form action="/member/orderProcess" method="post" class="order-form">
		...
		<div class="section-header">
		    ...
		    <div class="checkbox-group">
		        <input type="checkbox" id="sameAsMember" onclick="copyMemberInfo()">
		        <label for="sameAsMember">주문자 정보와 동일</label>
		    </div>
		</div>
			...
			<div class="payment-buttons">
			   <button type="button" onclick="requestPay('kakao')" class="pay-btn kakao">
				...
				<button type="button" onclick="requestPay('payco')" class="pay-btn payco">
				    <img src="${pageContext.request.contextPath}/assets/payco_logo.png" alt="페이코">
				</button>
			</div>
	</form>
</main>
