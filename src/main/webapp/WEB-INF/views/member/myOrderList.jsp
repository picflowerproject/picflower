	            ...
	            <tr>
	                ...
	                <td style="text-align: left; padding-left: 20px;">
	                    <strong>
	                        ...
	                        <c:if test="${order.product_count > 1}">
	                            <span style="color: #888; font-size: 0.9em;"> 외 ${order.product_count - 1}건 </span>
	                        </c:if>
	                    </strong>
	                </td>
	               ...
	               <td>
					    <div class="status-container">
					        <!-- 상태가 환불완료일 때 status-refund 클래스 추가 -->
					        <span class="status-badge ${order.o_status == '환불완료' ? 'status-refund' : ''}">
					            ${order.o_status}
					        </span>
					        
					        <c:if test="${order.o_status == '결제완료'}">
