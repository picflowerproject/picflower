...
public class boardController {
	...
	public String updateReview(boardDTO dto) {
	    try {
	        MultipartFile file = dto.getB_image();

	        if (file != null && !file.isEmpty()) {
	            // 실제 경로가 맞는지 반드시 다시 확인
	        ...
	        e.printStackTrace(); // 콘솔에 자세한 에러 로그가 찍힙니다.
	        return "fail";
	    }
	}
	...
	public String b_delete(@RequestParam("b_no") int b_no) {
	    ...
	    return "redirect:guest/b_list"; // 삭제 후 리스트로 새로고침 이동
	}
